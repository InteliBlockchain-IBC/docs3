...
const config: Config = {
  title: 'Docs³',
  tagline: 'Construindo o futuro da tecnologia blockchain',
  ...
  url: 'https://docs3.inteli-blockchain.com',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Inteli Blockchain, Inc. Built with Docusaurus.`,
    },
    prism: {
